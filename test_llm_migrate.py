...
def main():
    ...
    ok &= _check("stamps llm_config_version=2", out.get("llm_config_version") == 2)
    ...
    ok &= _check("bare config gets version-stamped", out3.get("llm_config_version") == 2 and changed3)
